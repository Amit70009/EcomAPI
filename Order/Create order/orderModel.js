...
var OrderSchema = new mongoose.Schema({
    ...
    order_item: [{
        ...
        product_discount_name: {type: String},
        product_discount_type: {type: String},
        product_discount_applied_on: {type: String},
        product_discount_amount: {type: Number},
        product_subtotal_price: {type: Number},
